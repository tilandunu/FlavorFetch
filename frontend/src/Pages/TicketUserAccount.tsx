...
export function TicketUserAccount() {
        ...
        <div className="w-1/4 border-r border-gray-200 p-6">
          <div className="mb-12">
            ...
            <ul className="space-y-6">
              <li>
                <Link to="/SupportTicket" className="text-lg font-semibold text-gray-700">
                  CREATE TICKET
                </Link>
              </li>
              <li>
  ...
  <Link to="">
    <Card className=" border border-black p-6 text-center  text-white-500 mt-1  hover:bg-red-700 hover:text-white text-black duration-300" >
      <CardContent>
